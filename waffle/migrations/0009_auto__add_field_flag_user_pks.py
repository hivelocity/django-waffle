...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flag.user_pks'
        db.add_column(u'waffle_flag', 'user_pks',
                      self.gf('waffle.fields.ListField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flag.user_pks'
        db.delete_column(u'waffle_flag', 'user_pks')
    ...
    models = {
        ...
        u'waffle.flag': {
            ...
            'user_pks': ('waffle.fields.ListField', [], {'null': 'True', 'blank': 'True'}),
